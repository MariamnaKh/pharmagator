...
public class PharmacyControllerTest {
    ...
    public void setup() {
        ...
        pharmacy = new PharmacyDto(8L, "My pharma", "linkk.com");
        pharmacy2 = new PharmacyDto(9L, "Second pharma", "secongPharma.com");
    ...
    public void postMappingOfPharmacy_pharmacyIsCreated() throws Exception {
        ...
        when(pharmacyService.createPharmacy(any(PharmacyDto.class))).thenReturn(pharmacy);
        ...
        verify(pharmacyService, times(1)).createPharmacy(any(PharmacyDto.class));
    ...
    public void getAllPharmacies_returnsPharmacies() throws Exception {
        ...
        when(pharmacyService.getAll()).thenReturn(pharmacyList);
        mockMvc.perform(MockMvcRequestBuilders.get(URI).
                        contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andDo(MockMvcResultHandlers.print());
        verify(pharmacyService, times(1)).getAll();
    ...
    public void DeleteById_ShouldDeletePharmacy() throws Exception {
        ...
        doNothing().when(pharmacyService).deletePharmacy(pharmacy.getId());
    ...
    public void testedResourceNotFoundException() throws Exception {
        ...
        when(pharmacyService.getById(anyLong())).thenThrow(new ResponseStatusException(HttpStatus.NOT_FOUND));
    ...
    public void GetMappingOfPharmacy_ShouldReturnRespectivePharmacy() throws Exception {
        ...
        when(pharmacyService.getById(pharmacy2.getId())).thenReturn(pharmacy2);
    ...
    public void putMappingOfPharmacy_pharmacyIsUpdated() throws Exception {
        ...
        when(pharmacyService.updatePharmacy(anyLong(), any(PharmacyDto.class))).thenReturn(pharmacy);
        mockMvc.perform(put(URI + "/" + pharmacy.getId()).
                ...
                .andExpect(jsonPath("$.name").value(pharmacy.getName()))
                .andExpect(jsonPath("$.medicineLinkTemplate").value(pharmacy.getMedicineLinkTemplate()));
        verify(pharmacyService, times(1)).updatePharmacy(anyLong(), any(PharmacyDto.class));
